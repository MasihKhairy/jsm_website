...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="index.html" class="logo d-flex align-items-center">
            ...
            <span class="d-none d-lg-block">JMS</span>
        </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul id="services-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                ...
                <li>
                    <a href="/Volunteer-job-description">
                        <i class="bi bi-circle"></i><span>Volunteer Job Description</span>
                    </a>
                </li>
            </ul>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" data-bs-target="#about-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-question-circle"></i><span>About us</span><i class="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="about-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                ...
                <li>
                    <a href="/Tetstimonials">
                        <i class="bi bi-circle"></i><span>Tetstimonials</span>
                    </a>
                </li>
            </ul>
        </li><!-- End Components Nav -->
...
<footer id="footer" class="footer">
    <div class="copyright">
        &copy; Copyright <strong><span>Job Mentoring Service</span></strong>. All Rights Reserved <br>
        Designed by SpotTech
    </div>
